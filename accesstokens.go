...
func (s *AccessTokens) IssueToken(ctx context.Context, request operations.IssueTokenRequest, opts ...operations.Option) (*operations.IssueTokenResponse, error) {
	...
	case httpRes.StatusCode == 401:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 403:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponseError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 406:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponse406Error
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 429:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponse429Error
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 500:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponse500Error
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 503:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponse503Error
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
	...
	case httpRes.StatusCode == 504:
		...
		switch {
		case utils.MatchContentType(contentType, `application/problem+json`):
			var out sdkerrors.IssueTokenAccessTokensResponse504Error
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
			out.RawResponse = httpRes
