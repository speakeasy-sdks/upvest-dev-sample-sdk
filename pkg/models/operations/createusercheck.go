...
func (u *CreateUserCheckUserCheckCreateRequest) UnmarshalJSON(data []byte) error {
	...
	createUserCheckUserCheckCreateRequestUserCheckInstrumentFitCreateRequest := new(CreateUserCheckUserCheckCreateRequestUserCheckInstrumentFitCreateRequest)
	...
	createUserCheckUserCheckCreateRequestUserCheckProofOfResidencyCreateRequest := new(CreateUserCheckUserCheckCreateRequestUserCheckProofOfResidencyCreateRequest)
	...
	createUserCheckUserCheckCreateRequestUserCheckKnowYourCustomerCreateRequest := new(CreateUserCheckUserCheckCreateRequestUserCheckKnowYourCustomerCreateRequest)
