...
func (u *TriggerPortfolioRebalancingTriggerPortfolioRebalancingRequest) UnmarshalJSON(data []byte) error {
	...
	triggerPortfolioRebalancingTriggerPortfolioRebalancingRequestAccounts := new(TriggerPortfolioRebalancingTriggerPortfolioRebalancingRequestAccounts)
	...
	triggerPortfolioRebalancingTriggerPortfolioRebalancingRequestAllocations := new(TriggerPortfolioRebalancingTriggerPortfolioRebalancingRequestAllocations)
