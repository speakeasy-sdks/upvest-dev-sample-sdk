...
func (u *SetTaxResidenciesTaxResidenciesSetRequestTaxResidencyForCreateRequest) UnmarshalJSON(data []byte) error {
	...
	setTaxResidenciesTaxResidenciesSetRequestTaxResidencyForCreateRequestWithTaxIdentifierNumber := new(SetTaxResidenciesTaxResidenciesSetRequestTaxResidencyForCreateRequestWithTaxIdentifierNumber)
	...
	setTaxResidenciesTaxResidenciesSetRequestTaxResidencyForCreateRequestWithoutTaxIdentifierNumber := new(SetTaxResidenciesTaxResidenciesSetRequestTaxResidencyForCreateRequestWithoutTaxIdentifierNumber)
...
func (u *SetTaxResidenciesTaxResidencyRecordTaxResidency) UnmarshalJSON(data []byte) error {
	...
	setTaxResidenciesTaxResidencyRecordTaxResidencyWithTaxIdentifierNumber := new(SetTaxResidenciesTaxResidencyRecordTaxResidencyWithTaxIdentifierNumber)
	...
	setTaxResidenciesTaxResidencyRecordTaxResidencyWithoutTaxIdentifierNumber := new(SetTaxResidenciesTaxResidencyRecordTaxResidencyWithoutTaxIdentifierNumber)
